 ...
 *
 *
 * Operation: 'GoalAdjustments_PostMajorPurchaseByIdGoaladjustments'
 * Endpoint Path: '/api/GoalAdjustments/MajorPurchase/{id}/Calculations'
 * Method: 'post'
 *
 */
...
function processAction(msg, cfg) {
    ...
    let callParams = {
        ...
        pathName: '/api/GoalAdjustments/MajorPurchase/{id}/Calculations',
        method: 'post',
